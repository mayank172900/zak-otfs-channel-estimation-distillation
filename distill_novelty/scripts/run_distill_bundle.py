...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the distillation benchmark and full evaluation bundle.")
...
def main() -> int:
    ...
    benchmark_student_models(config, checkpoint_path=args.checkpoint)
